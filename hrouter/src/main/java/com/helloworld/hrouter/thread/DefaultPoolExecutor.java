package com.helloworld.hrouter.thread;


import android.util.Log;

import com.helloworld.hrouter.util.Consts;
import com.helloworld.hrouter.util.TextUtils;
...
public class DefaultPoolExecutor extends ThreadPoolExecutor {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (t != null) {
            Log.i(Consts.TAG, "Running task appeared exception! Thread [" + Thread.currentThread().getName() + "], because [" + t.getMessage() + "]\n" + TextUtils.formatStackTrace(t.getStackTrace()));
        }
    }
}
